...
This guide contains information to help onboard developers to work on the [mssql](https://www.microsoft.com/en-us/sql-server) integration, hereafter referred to as *the plugin*.
