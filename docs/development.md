...
This guide contains information to help onboard developers to work on the [mssql](https://mssql.microsoft.com/en-us/) integration, hereafter referred to as *the plugin*.
